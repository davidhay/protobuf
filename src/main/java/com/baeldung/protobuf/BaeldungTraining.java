...
public final class BaeldungTraining {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 3,
      /* suffix= */ "",
      BaeldungTraining.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.baeldung.protobuf.BaeldungTraining.Course result) {
        if (studentBuilder_ == null) {
      ...
      private void buildPartial0(com.baeldung.protobuf.BaeldungTraining.Course result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                com.baeldung.protobuf.BaeldungTraining.Student m =
                    input.readMessage(
                        com.baeldung.protobuf.BaeldungTraining.Student.parser(),
                        extensionRegistry);
                if (studentBuilder_ == null) {
                  ensureStudentIsMutable();
                  student_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
       ...
       * @return The type.
       */
      @java.lang.Override public com.baeldung.protobuf.BaeldungTraining.Student.PhoneType getType() {
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(com.baeldung.protobuf.BaeldungTraining.Student.PhoneNumber result) {
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.baeldung.protobuf.BaeldungTraining.Student result) {
        if (phoneBuilder_ == null) {
      ...
      private void buildPartial0(com.baeldung.protobuf.BaeldungTraining.Student result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.id_ = id_;
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42: {
                com.baeldung.protobuf.BaeldungTraining.Student.PhoneNumber m =
                    input.readMessage(
                        com.baeldung.protobuf.BaeldungTraining.Student.PhoneNumber.parser(),
                        extensionRegistry);
                if (phoneBuilder_ == null) {
                  ensurePhoneIsMutable();
                  phone_.add(m);
